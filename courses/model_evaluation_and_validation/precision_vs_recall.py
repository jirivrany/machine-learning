...
results = {
  "Naive Bayes Recall": recall(y_test,clf1.predict(X_test)),
  "Naive Bayes Precision": precision(y_test,clf1.predict(X_test)),
  "Decision Tree Recall": recall(y_test,clf2.predict(X_test)),
  "Decision Tree Precision": precision(y_test,clf2.predict(X_test))
}